        ...
        if ($transaction_type == 'sell' && $transaction->status == 'final') {
            ...
            if ($il->show_payments == 1) {
                ...
                if (! empty($payments)) {
                    ...
                    if ($change_return_total > 0) {
                        $output['change_return'] = $this->num_f($change_return_total, $show_currency, $business_details);
                    }
                }
            }
        }
